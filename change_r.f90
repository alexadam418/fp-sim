program change_r
    ...
    double precision :: length_init = 0.01, start_lamda = 600e-9, finish_lamda = 1050e-9, step = 1e-9
    double precision, dimension(6,3) :: peaks
    integer :: counter = 0, counter2
    real :: upper_in, lower_in, lower_out
    real, dimension(1000) :: upper_out, R1
...
!===========================================================================================
    do i=1,1000
     ...
     spectrum_out = scan_cavity(spectrum_in, R1(i)*1D0, R1(i)*1D0, length_init, start_lamda, finish_lamda, step)
...
!
!============================================================================================    
     call ps_init(pform='A0_P', rot90=0, fileout='r_changing')
     call ps_frame(1, R1(1), minval(upper_out), R1(1000), maxval(upper_out), &
